...
namespace Zenject
{
	...
	public class SubContainerCreatorByMethod<TParam1, TParam2, TParam3> : SubContainerCreatorByMethodBase
	{
		...
		public override DiContainer CreateSubContainer(List<TypeValuePair> args, InjectContext context)
		{
			...
			DiContainer subContainer = CreateEmptySubContainer();
			_installMethod(subContainer, (TParam1)args[0].Value, (TParam2)args[1].Value, (TParam3)args[2].Value);
			subContainer.ResolveRoots();
			return subContainer;
		}
	}
	...
	public class SubContainerCreatorByMethod<TParam1, TParam2, TParam3, TParam4> : SubContainerCreatorByMethodBase
	{
		...
		public override DiContainer CreateSubContainer(List<TypeValuePair> args, InjectContext context)
		{
			...
			DiContainer subContainer = CreateEmptySubContainer();
			_installMethod(subContainer, (TParam1)args[0].Value, (TParam2)args[1].Value, (TParam3)args[2].Value, (TParam4)args[3].Value);
			subContainer.ResolveRoots();
			return subContainer;
		}
	}
	...
	public class SubContainerCreatorByMethod<TParam1, TParam2, TParam3, TParam4, TParam5> : SubContainerCreatorByMethodBase
	{
		...
		public override DiContainer CreateSubContainer(List<TypeValuePair> args, InjectContext context)
		{
			...
			DiContainer subContainer = CreateEmptySubContainer();
			_installMethod(subContainer, (TParam1)args[0].Value, (TParam2)args[1].Value, (TParam3)args[2].Value, (TParam4)args[3].Value, (TParam5)args[4].Value);
			subContainer.ResolveRoots();
			return subContainer;
		}
	}
	...
	{
		private readonly ModestTree.Util.Action<DiContainer, TParam1, TParam2, TParam3, TParam4, TParam5, TParam6> _installMethod;
		...
		public override DiContainer CreateSubContainer(List<TypeValuePair> args, InjectContext context)
		{
			...
			DiContainer subContainer = CreateEmptySubContainer();
			_installMethod(subContainer, (TParam1)args[0].Value, (TParam2)args[1].Value, (TParam3)args[2].Value, (TParam4)args[3].Value, (TParam5)args[4].Value, (TParam6)args[5].Value);
			subContainer.ResolveRoots();
			return subContainer;
		}
	}
	...
	{
		private readonly ModestTree.Util.Action<DiContainer, TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TParam7, TParam8, TParam9, TParam10> _installMethod;
		...
		public override DiContainer CreateSubContainer(List<TypeValuePair> args, InjectContext context)
		{
			...
			DiContainer subContainer = CreateEmptySubContainer();
			_installMethod(subContainer, (TParam1)args[0].Value, (TParam2)args[1].Value, (TParam3)args[2].Value, (TParam4)args[3].Value, (TParam5)args[4].Value, (TParam6)args[5].Value, (TParam7)args[6].Value, (TParam8)args[7].Value, (TParam9)args[8].Value, (TParam10)args[9].Value);
			subContainer.ResolveRoots();
			return subContainer;
		}
	}
