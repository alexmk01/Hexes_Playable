...
namespace Zenject
{
	...
	{
		public PoolableStaticMemoryPool()
			: base((ModestTree.Util.Action<TParam1, TParam2, TParam3, TParam4, TValue>)OnSpawned, (Action<TValue>)OnDespawned)
		{
		}
	...
	{
		public PoolableStaticMemoryPool()
			: base((ModestTree.Util.Action<TParam1, TParam2, TParam3, TParam4, TParam5, TValue>)OnSpawned, (Action<TValue>)OnDespawned)
		{
		}
	...
	{
		public PoolableStaticMemoryPool()
			: base((ModestTree.Util.Action<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TValue>)OnSpawned, (Action<TValue>)OnDespawned)
		{
		}
	...
	{
		public PoolableStaticMemoryPool()
			: base((ModestTree.Util.Action<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TParam7, TValue>)OnSpawned, (Action<TValue>)OnDespawned)
		{
		}
